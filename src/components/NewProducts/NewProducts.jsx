...
const NewProducts = () => {
    ...
    return (<div className="max-w-screen-xl mx-auto my-8 md:my-16">
        {isLoading && <Loading />}
        {isSuccess &&
            <>
                    ...
                    <div className="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                        {newProducts.map((product) => (
                            ...
                            >
                                ...
                                <p className="mt-1 text-base font-medium text-gray-900">NT${product.attributes.price.toLocaleString('en-US')}</p>
                            </Link>
                        ))}
                    </div>
                </div>
